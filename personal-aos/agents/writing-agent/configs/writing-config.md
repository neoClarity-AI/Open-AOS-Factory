---
title: Writing / Content Agent — Config
file_type: config
...
# Writing / Content Agent — Config

## Inherited Rules
References `/configs/global-permissions.md`. This agent does not duplicate or override global rules.

## Tool Access
References `/configs/tool-access-matrix.md` (authoritative). Agent-specific note: Publish/send = approval-required.
