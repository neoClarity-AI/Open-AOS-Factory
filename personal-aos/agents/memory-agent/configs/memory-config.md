...
## Tool Access
References `/configs/tool-access-matrix.md` (authoritative). Agent-specific note: Read/write across global memory files; defines its own scope in its config.
