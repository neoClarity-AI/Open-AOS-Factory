---
title: Security / Permissions Agent — Config
file_type: config
...
# Security / Permissions Agent — Config

## Inherited Rules
References `/configs/global-permissions.md`. This agent does not duplicate or override global rules.

## Tool Access
References `/configs/tool-access-matrix.md` (authoritative). Agent-specific note: References `/configs/tool-access-matrix.md`; owns it. New tools default to Not configured.
