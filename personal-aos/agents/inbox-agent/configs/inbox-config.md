---
title: Inbox / Communications Agent — Config
file_type: config
...
# Inbox / Communications Agent — Config

## Inherited Rules
References `/configs/global-permissions.md`. This agent does not duplicate or override global rules.

## Tool Access
References `/configs/tool-access-matrix.md` (authoritative). Agent-specific note: Email/message read = Not configured until a connector is granted; send = approval-required.
